...
const ContactUsForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 text-sm lg:text-base opacity-80">
      ...
      <button type="submit" className="cursor-pointer hover:bg-secondery active:bg-secondery bg-foreground text-background py-2 px-4 text-lg rounded-xl active:duration-700 active:scale-105 hover:scale-105 active:opacity-90 hover:opacity-90 hover:duration-300">
        ارسال پیام
      </button>
    </form>
  );
