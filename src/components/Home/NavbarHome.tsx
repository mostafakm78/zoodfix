    ...
    <>
      ...
      <div className={sideMenu ? 'fixed z-[47] translate-x-0 duration-500 h-full md:w-2/5 w-3/5 right-0 top-0 bg-third shadow' : 'fixed z-[47] translate-x-full duration-500 h-full md:w-2/5 w-3/5 right-0 top-0 bg-third shadow'}>
        ...
        <div className="flex px-10 mt-6 flex-col">
          ...
          <Link href="/employment" className="hover:text-[#28BE31] relative after:absolute hover:scale-110 px-1 py-2 hover:rounded-4xl duration-200 after:content-[''] after:h-[1.5px] after:w-full after:bg-black after:opacity-30 after:rounded-full after:bottom-0 after:right-0">
            استخدام
          </Link>
        </div>
      </div>
      ...
      {!isScrolled && (
        <section className={`w-full z-40 lg:top-12 top-6 absolute xl:px-10 lg:px-0 flex justify-evenly items-center`}>
          ...
          <div className="w-2/4 text-background lg:flex hidden space-x-3 justify-start">
            ...
            <Link href="/employment" className="hover:text-[#28BE31] hover:bg-yellow-200 px-1 py-2 hover:rounded-4xl duration-200">
              استخدام
            </Link>
          </div>
          <div className="flex flex-col">
            <div>
              ...
              <div className="flex justify-center items-center gap-2">
                <Link href="tel:+989169799533" className="flex justify-center items-center active:scale-110 hover:scale-105 active:duration-500 hover:duration-200 gap-2">
                ...
                <button onClick={() => setShowSearchBar(!showSearchBar)} className="bg-background active:scale-110 active:duration-500 hover:scale-105 hover:duration-200 lg:w-8 lg:h-8 w-6 h-6 rounded-full flex items-center justify-center">
