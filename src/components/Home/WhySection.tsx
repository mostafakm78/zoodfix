...
export const WhySection = () => {
  return (
    <div className="container mx-auto">
      <div className="w-full bg-background shadow-lg p-20 rounded-b-[90%]">
        <div className="flex mb-10 items-center p-12">
          <div className="flex flex-col items-start space-y-2 w-2/12">
            ...
            <span className="text-xl bg-gray-600 text-background px-3 py-1 rounded-full">درباره زودفیکس</span>
          </div>
