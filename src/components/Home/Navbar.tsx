...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      <section className={isScrolled ? 'w-full z-40 duration-500 translate-y-0 fixed md:h-20 h-12 shadow-lg bg-secondery xl:px-10 lg:px-0 flex justify-evenly items-center' : 'w-full z-40 -translate-y-40 fixed h-12 md:h-20 shadow-lg bg-secondery xl:px-10 lg:px-0 flex justify-evenly items-center'}>
        <Link href="/">
